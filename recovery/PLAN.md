...
## Track 1 — Reconstruct the lost fork work (corpus 93 → 110)

The 74→93 round (ce1ad3a..7526f01): NOP-fill of suppressed regions
(03, 86, 78/79/122, 27, 39, 48, 54, 94, 125 — the stale-byte class),
LDOUBLE-as-double in slot/deref/convert paths (70, 101, 22, 111),
nocode-suppressed jump edges (88), __wasm_call_ctors/fini (108), the
